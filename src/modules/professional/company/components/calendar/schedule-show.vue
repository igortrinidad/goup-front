        ...
        <div class="first-container">
            ...
            <div class="container">
                ...
                <div class="card" v-if="!placeholder.client">
                    <div class="card-header ch-alt text-center">
                        ...
                        <router-link tag="div"  class="cursor-pointer" :to="{name: 'admin.companies.client.show', params: {company_id: $route.params.company_id, client_id: schedule.subscription.client.id}}">
                            <div
                                class="picture-circle picture-circle-xs"
                                :style="`background-image:url('${ schedule.subscription.client.avatar }')`"
            ...
            <div class="container" v-if="schedule.professional">
                ...
                <div class="card" v-if="!placeholder.professional">
                    <div class="card-header ch-alt text-center">
                        ...
                        <span class="f-300">{{ schedule.professional.email }}</span>
                    </div>
                </div>
            </div>
            <!-- / Professional Infos -->
            ...
            <div class="container">
                ...
                <div class="card" v-if="!placeholder.plan">
                    ...
                    <div class="card-body card-padding text-center">
                        <p class="m-t-0 m-b-20 f-300">Vigência</p>
                        <span class="f-300">
                            <strong class="m-r-5">Início:</strong>{{ schedule.subscription.start_at }}
                        </span>
                        <hr>
                        <span class="f-300">
                            <strong class="m-r-5">Término:</strong>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions(['addOnMonthSchedules','addOnSelectedDaySchedules', 'removeFromMonthSchedules', 'removeFromSelectedDaySchedules', 'setLoading']),
            ...
            confirmSchedule(){
                ...
                this.old_schedule_data = _.cloneDeep(that.schedule)
            ...
            getSchedules(payload) {
                ...
                that.$http.post('professional/company/schedule/calendar_list_new', {
                    company_id: that.schedule.company_id,
                    category_id: that.schedule.category_id,
                    start: start,
                    end: end
                })
                    .then(function (response) {
            ...
            handleReschedule(schedule) {
                ...
                if (old_schedule_date.isSame(schedule_date, 'day')) {
                    ...
                    that.addOnSelectedDaySchedules(schedule)
                } else {
                    ...
                    if (old_schedule_date.isSame(schedule_date, 'month')) {
                        ...
                        that.addOnMonthSchedules(schedule)
                        that.removeFromSelectedDaySchedules(that.old_schedule_data)
                    } else {

                        //if the new schedule month is different remove from current month
                        that.removeFromMonthSchedules(schedule)
                        that.removeFromSelectedDaySchedules(that.old_schedule_data)
                    }
                }
            ...
            handleSlotDay(payload) {
                ...
                if(is_past < 0){
                    ...
                    that.$swal({
                        ...
                        if(payload.is_professional_scheduled){
