<template>
    ...
    <div>
        ...
        <div class="container">
            ...
            <h4 class="text-center f-300" v-if="non_clients.length">Outros clientes</h4>
        ...
        <!-- Confirmed clients -->
        <div class="container">
            <h4 class="text-center f-300 m-b-30">Clientes confirmados</h4>
        ...
        <div class="container">
            ...
            <div class="row"  v-if="interactions.showUnconfirmedClients">
                <h4 class="text-center f-300">Clientes não confirmados</h4>
        ...
        <div class="container">
            ...
            <h4 class="text-center f-300">Clientes removidos</h4>
