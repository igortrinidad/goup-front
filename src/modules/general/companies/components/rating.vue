<template lang="html">
    <div class="first-container">
        ...
        <div class="container">
            <div class="card m-t-20">
                <div class="card-body card-padding text-center">
                    <p class="f-16">Sua avaliação é muito importante para o profissional.</p>
                </div>
            </div>
        ...
        <!-- Last Ratings -->
        <div class="container m-t-20" v-if="company.last_ratings.length">
        ...
        <div class="container m-t-20" v-if="!company.last_ratings.length">
            <p class="text-center f-300 m-t-30">Essa empresa ainda não possui avaliações.</p>
        </div>
        <!-- Last Ratings -->
