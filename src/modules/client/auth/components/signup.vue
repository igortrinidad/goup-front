                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="notification notification-default text-center">
                            <span class="d-block">Cadastre-se como <b>Usuário</b> para cuidar da sua saúde com ajuda de milhares de profissionais em todo o país.</span>
                            <span class="d-block m-t-10">Você pode cadastrar utilizando sua conta do Facebook ou informando os dados abaixo.</span></div>
        ...
        <form class="form" method="post">
            <div class="container-form">
                ...
                <div class="form-group full">
                    ...
                    <input type="text" class="form-control" placeholder="URL única (nome de usuário)" v-model="user.slug" @blur="checkSlug()"
        ...
        methods: {
            ...
            signup() {
                ...
                this.$validator.validateAll().then(() => {
                    ...
                    that.$http.post('auth/client/signup', that.user)
                        .then(function (response) {
                            ...
                            if(response.data.status == 422){
                                ...
                                that.$swal({
                                    ...
                                    that.$router.push({path: '/cliente/login'})
                                })
            ...
            checkSlug: function(){
                ...
                that.$http.get(`check_slug/client/${that.user.slug}`)
                .then(function (response) {
