<template>
    <div class="first-container">
        ...
        <section>
            <div class="container">
                <form class="container-form" id="loginform" action="index.html">
                    <div class="row">
                        <div class="col-sm-12 text-center">
                            ...
                            <div class="card m-b-0">
                                <div class="card-body card-padding">
                                    <p class="f-300 m-b-0">Faça o login como usuário para gerenciar o dashboard de sua saúde.</p>
                                </div>
                            </div>
                        </div>
                ...
                <form @submit="login" class="m-t-10">
                    <div :class="{'form-group': true, 'has-error': errors.has('email')}">
                        ...
                        <input
                            ...
                            placeholder="email"
                            class="form-control"
                            data-vv-name="email" data-vv-as="e-mail"
                            v-model="email"
                        >
                    ...
                    <div :class="{'form-group': true, 'has-error': errors.has('password')}">
                        ...
                        <div class="text-right">
                            <router-link
                                ...
                                :to="{name: 'landing.reset-pass', params: {usertype: 'client'}}"
        ...
        <div class="container text-center">
            <div class="row">
                <div class="col-sm-12 text-center f-18">
                    <div class="card m-b-0">
                        <div class="card-body card-padding">
                            <span class="f-300">Não possui cadastro? <router-link to="/cliente/cadastro">Cadastre-se aqui!</router-link></span>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12 m-t-20 text-center">
                    <div class="card">
                        <div class="card-header ch-alt p-10">
                            <h3 class="f-300 m-0">É profissional ?</h3>
                        </div>
                        <div class="card-body card-padding">
                            <span class="f-300 d-block">Se você é profissional da saúde acesse a área do profissional.</span>
                            <router-link tag="button" class="btn btn-primary p-5 p-l-10 p-r-10 f-300 m-t-15" to="/login">Acessar como Profissional</router-link>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    export default{
        ...
        methods: {
             ...
             */
            ...mapActions(['authSetToken', 'authSetUser', 'setLoading', 'setClientCompanies']),
            ...
            login(){
                ...
                this.$validator.validateAll().then(() => {
                    ...
                    that.$http.post('/client/auth/login', {email: that.email, password: that.password})
            ...
            handleRedirect(id){
                ...
                return redirect_to ? redirect_to : {name: 'client.dashboard', params: {client_id: id}};
            },
            ...
            getClientCompanies() {
                let that = this
                that.$http.get('client/company/full_list')
                    .then(function (response) {
                        that.setClientCompanies(response.data.companies)
                    })
                    .catch(function (error) {
                        console.log(error)
                    });
