...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            ...mapActions(['setLoading', 'decrementClientUnreadNotifications']),

            getNotifications() {
                let that = this

                that.$http.get('client/notification/list')
            ...
            navigate(page) {
                ...
                that.$http.get(`client/notification/list?page=${page}`)
                    .then(function (response) {
            ...
            markNotificationAsReaded(notification, index) {
                ...
                that.$http.get(`client/notification/mark_readed/${notification.id}`)
                    .then(function (response) {

                        that.notifications.splice(index, 1)
                        that.notifications.splice(index, 0, response.data.notification)

                        that.decrementClientUnreadNotifications(1);
            ...
            markAllNotificationAsReaded() {
                ...
                that.$swal({
                    ...
                    that.$http.get('client/notification/mark_all_readed')
                        .then(function (response) {
                            ...
                            that.decrementClientUnreadNotifications(response.data.readed_notifications);
