    ...
    <div>
        <div id="side-menu-global-id" :class="{ 'side-menu': true, 'active': isOpened }">
            ...
            >
                ...
                <span class="badge badge-primary user-notification-count">{{professionalUnreadedNotifications}}</span>
            </router-link>
...
>>>>>>> app is working without erros again
        ...
        methods: {
            ...
            ...mapActions(['setClientTotalXp', 'setClientUnreadNotifications', 'setProfessionalUnreadNotifications']),
            ...
            ProfessionalNotificationsStatus(){
                let that = this
                that.$http.get('professional/status')
                    .then(function (response) {
                        that.setProfessionalUnreadNotifications(response.data.unreaded_notifications)
                    })
                    .catch(function (error) {
                        console.log(error)
                    });
